          ...
          <div className="col-12 col-md-3 col-lg-3">
            <div className="mb-2 section-title text-center">
              ...
              <p className="m-0 text-secondary">
                Your Premier Healthcare Team Awaits.
              </p>
            </div>
            <div className="form-text">
              <p>
                Meet Our Exceptional Team of Doctors, Where Compassion Meets
                Expertise.
              </p>
              <p>
                Discover a world where your health is our priority, where every
                interaction is infused with compassion and expertise. From
                routine check-ups to complex procedures, our dedicated team of
                doctors is here to ensure you receive the best possible care.
                Trust in our unwavering commitment to your well-being and embark
                on a journey towards a healthier, happier you. Welcome to our
                community of excellence in healthcare, where your health is our
                passion.
              </p>
